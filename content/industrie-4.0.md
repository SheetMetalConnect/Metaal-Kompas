...
De **[[unified-namespace|Unified Namespace]]** wordt vaak gezien als *best practice* om dit te realiseren, vooral voor middelgrote en grote ondernemingen die een centrale datalaag nodig hebben. Maar het is géén harde eis:  

### Groeipad naar Industrie 4.0
1. **Basisfase – Connectiviteit:** bedrijven beginnen vaak met koppelingen tussen bestaande systemen zoals ERP, CRM, MES of CAD/CAM. Dit doorbreekt silo’s op een pragmatische manier en maakt eerste data-uitwisseling mogelijk.  
2. **Groeifase – Datahub:** zodra de behoefte ontstaat om data uit meerdere bronnen breder beschikbaar te maken, groeit de vraag naar een **centrale datahub**. Dit helpt om inzichten te bundelen en informatie makkelijker te delen tussen afdelingen.  
3. **Volwaardige Industrie 4.0 – Unified Namespace:** in volwassen omgevingen, vooral bij grotere MKB-bedrijven en enterprises, ontstaat de noodzaak voor een **UNS**. Dit is een real-time digitale ruggengraat waarin álle informatiestromen samenkomen en systemen publish/subscribe gebruiken in plaats van point-to-point koppelingen.  
...
> [!summary] Verschil tussen Industrie 3.0 en 4.0  
...
- **IIoT** met protocollen als [[message-queuing-telemetry-transport|MQTT]], [[apache-kafka]] en [[opc-ua-pub-sub|OPC UA]]  
...
Industrie 4.0 legt de infrastructuur voor de volgende fase: **[[industrie-5.0|Industrie 5.0]]**. Waar 4.0 draait om connectiviteit en intelligentie, zal 5.0 de nadruk leggen op **mensgerichtheid, duurzaamheid en samenwerking tussen mens en machine**.
